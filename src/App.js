...
const App = () => {
  return (
    <>
      ...
      />
      <Layout title="Happy text number 1" urlBg={PokemonBg}>
        <p>Text</p>
        <p>Text</p>
      </Layout>
      <Layout id="cards" title="cards" colorBg="#202736">
        <div className="flex">
          {POKEMONS.map((item) => (
      ...
      <Layout title="Happy text number 2" colorBg="#eee">
        <p>
      ...
      <Layout title="Happy text number 3" urlBg={PokemonBg}>
        <p>Text</p>
        <p>Text</p>
      </Layout>
      <Footer />
